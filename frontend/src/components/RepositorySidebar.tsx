                      ...
                      <div className="space-y-1 px-2">
                        {repositories.map((repo) => (
                          <div
                            key={repo.path}
                            className={cn(
                              "group flex items-center justify-between p-2 rounded-md cursor-pointer hover:bg-accent transition-colors",
                              repo.current && "bg-accent"
                            )}
                          >
                            <div 
                            ...
                            <Button
                              ...
                              onClick={(e) => {
                                e.stopPropagation()
                                onRemoveRepository(repo.path, repo.name)
                              }}
